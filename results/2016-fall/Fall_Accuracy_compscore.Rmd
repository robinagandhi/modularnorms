...
```
Shapiro-Wilk test indicates that the distributions are different from normal (p<0.1 for both sessions) - this is different from the same tests in Demographics_Analysis_HS.
